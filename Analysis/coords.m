function returnarray = coords(fname)

% reading the surface, calculating the size of the square and appending
% first point of surf to the end to calculate centre points of surface
% segments
